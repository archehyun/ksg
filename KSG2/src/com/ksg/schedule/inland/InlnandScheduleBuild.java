package com.ksg.schedule.inland;
 ...
 *
 */
public class InlnandScheduleBuild extends DefaultScheduleBuild{
	...
	public InlnandScheduleBuild(ScheduleData option) throws SQLException {
		super();
		this.option=option;
