package com.ksg.schedule.console;
 ...
 *
 */
public class ConsoleScheduleBuild extends DefaultScheduleBuild{
	...
	public ConsoleScheduleBuild(ScheduleData op) throws SQLException {
		super();
		this.op=op;
