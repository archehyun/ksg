 ...
 *       
 */
public class RouteScheduleBuildV3_1 extends DefaultScheduleBuild{
	...
	class GroupVessel implements Groupable
	{
		...
		private String getVoyageInfo(String vessel) {
			...
			int result=RouteScheduleBuildV3_1.this.getNumericVoyage(vessel);
	...
	public static void main(String[] args) {
		...
		new RouteTaskV3_1(op,RouteTaskV3_1.ORDER_BY_DATE).start();*/
		String a = "SKIP-MOL";
		String b = "Saigon Bridge";
		String c = "skip-mol";
	...
	public RouteScheduleBuildV3_1(ShippersTable op) throws SQLException {
	...
	public RouteScheduleBuildV3_1(ShippersTable op, int orderBy) throws SQLException {
		this(op);
	...
	/*public void start()
	{
		...
		try {
			fileName = KSGPropertis.getIntance().getProperty(KSGPropertis.SAVE_LOCATION)+"/"+"world_print_new_"+(orderByType==RouteTaskV3_1.ORDER_BY_DATE?"date":"vessel")+".txt";
			initTag();
			excute();
		} catch (Exception e) {
			// TODO Auto-generated catch block
