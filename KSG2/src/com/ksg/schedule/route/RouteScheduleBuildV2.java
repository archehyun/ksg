...
public class RouteScheduleBuildV2 extends DefaultScheduleBuild {
	final int FORWARD =0;
	final int BACK =1;
	...
	public RouteScheduleBuildV2(ShippersTable op) throws SQLException {
		super();
	...
	class ScheduleResult
	{
		...
		private String createKey(ScheduleData data) {
			...
			return vessel+":"+RouteScheduleBuildV2.this.getNumericVoyage(voy);
		}
