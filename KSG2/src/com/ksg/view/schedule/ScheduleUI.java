...
public class ScheduleUI extends JPanel implements ActionListener {
	...
	private void createAndUpdateUI() 
	{
		...
		try {
			...
			JOptionPane.showMessageDialog(ScheduleUI.this, e.getMessage());
			e.printStackTrace();
		}
...
/*		if(gubun.equals(ShippersTable.GUBUN_NORMAL))
		{
			_tblNormalScheduleList.updateTable(data);
		}
		else if(gubun.equals(ShippersTable.GUBUN_CONSOLE))
		{
			_tblConsoleScheduleList.updateTable(data);
		}*/
...
/*			_tblNormalScheduleList.updateTable(new ScheduleData());
			_tblInlandScheduleList.updateTable(new ScheduleData());
			_tblConsoleScheduleList.updateTable(new ScheduleData());*/
		...
		{
			e1.printStackTrace();
			JOptionPane.showMessageDialog(ScheduleUI.this, "error:"+e1.getMessage());
		}
	}
	...
	private JPanel buildSouthPn() {
		...
		butErrorLog.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				JOptionPane.showMessageDialog(ScheduleUI.this, errorLogManager.getLogger());
	...
	class SchedulePrintAction implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) {
			...
			try{
				if(command.equals(ACTION_PRINT_FLIE))
				{
					...
					if(gubun.equals(ShippersTable.GUBUN_CONSOLE))
					{
						...
						ScheduleBuild console=scheduleManager.getConsoleSchedudle(op);
			...
			{
				ee.printStackTrace();
				JOptionPane.showMessageDialog(ScheduleUI.this, ee.getMessage());
			}
		}
	}
