...
import com.ksg.view.base.code.PnCode;
import com.ksg.view.comp.KSGDialog;
import com.ksg.view.util.ViewUtil;

public class InsertInboundCodeInfodialog extends KSGDialog implements ActionListener {
	/**
	 * 
	 */
	...
	public InsertInboundCodeInfodialog(BaseInfoUI base, String string,PnCode code) {
		this(base,string);
		this.baseCode = code;
	}

	public InsertInboundCodeInfodialog() {
		this.code_type="fromPort";
		title ="Inbound 출발 항구";
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(command.equals("확인"))
		{
			...
			}catch(SQLException sqle)
			{
				...
				{	
					JOptionPane.showMessageDialog(InsertInboundCodeInfodialog.this, "코드가 존재합니다.");
