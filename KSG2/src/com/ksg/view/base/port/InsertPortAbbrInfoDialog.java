...
public class InsertPortAbbrInfoDialog extends KSGDialog implements ActionListener{
	/**
	 * 
	 */
	...
	public InsertPortAbbrInfoDialog(Dialog dialog,String port_abbr,String port_name) {
		super(dialog);
