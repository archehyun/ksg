 ...
 * @author Raven
 */
public class PopupSubmenu2 extends JPanel {
    ...
    public PopupSubmenu2(ComponentOrientation orientation, Menu menu, int menuIndex, String menus[], List<MenuEvent> events) {
        this.menu = menu;
