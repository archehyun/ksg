...
public class KSGDatePickerImpl extends JPanel implements JDatePicker {
	...
	public KSGDatePickerImpl(JDatePanelImpl dateInstantPanel) {
	 ...
	 * @param formatter
	 */
	public KSGDatePickerImpl(JDatePanelImpl datePanel, JFormattedTextField.AbstractFormatter formatter) {
		...
		button = new ImageButton("images/date_picker.png");
		...
		formattedTextField.setPreferredSize(new Dimension(w-h-1, h-4));
