...
public class Notification extends javax.swing.JComponent {
    ...
    public Notification(Frame fram, Type type, Location location, String message) {
        this.fram = fram;
        if(fram == null) throw new RuntimeException("null frame");
        this.type = type;
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/notification/sucess.png")));
            lbMessage.setText("Success");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/notification/info.png")));
            lbMessage.setText("Info");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/notification/warning.png")));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/notification/sucess.png"))); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/notification/close.png"))); // NOI18N
